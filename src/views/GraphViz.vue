<template>
  <div style="width:1800px;">
    <div id="graph" class="w-full">
      <v-chart :option="chartOption" :autoresize="true" style="height: 800px;"></v-chart>
    </div>
    <div class="navbar flex justify-between items-center p-4 shadow-lg w-full">
      <div>
        <form @submit.prevent="search" class="flex gap-2">
          <input v-model="searchQuery" type="text" placeholder="Search for Movie Title" class="form-control">
...
import ECharts from 'vue-echarts'; // import the ECharts module
